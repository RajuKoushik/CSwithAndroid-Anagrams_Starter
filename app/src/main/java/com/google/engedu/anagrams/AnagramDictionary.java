...
public class AnagramDictionary {
    ...
    public String pickGoodStarterWord() {
        ...
        int sp = random.nextInt(maxlength), loopIndex;
        String key;
        for (loopIndex=sp; loopIndex < (maxlength+sp+1); loopIndex++){
            key = wordArray.get(loopIndex % maxlength);
        ...
        wordLength += 1;
        return wordArray.get(loopIndex % maxlength);
    }


    public String sortLetters(String name){
